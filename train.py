...
from myExperiment.exp_def import TaskDefs
...
def model_config(parser):
    ...
    parser.add_argument("--answer_mem_drop_p", type=float, default=0.1) #0.1
    ...
    parser.add_argument("--answer_dropout_p", type=float, default=0.1) #0.1
...
def data_config(parser):
    ...
    parser.add_argument("--tensorboard_logdir", default="/content/drive/MyDrive/MY-MT-DNN_Okay/myTensorBoardLogDir")
    parser.add_argument(
        "--init_checkpoint",
        default="bert-base-uncased",
        type=str,
    )
    parser.add_argument("--data_dir", default="/content/drive/MyDrive/MY-MT-DNN_Okay/data/canonical_data/bert-base-uncased")
    ...
    parser.add_argument("--train_datasets", default="s,fnd,sqdc,htiee")
    parser.add_argument("--test_datasets", default="s,fnd,sqdc,htiee")
...
def main():
    ...
    for epoch in range(0, args.epochs):
        ...
        start = datetime.now()
        print("********** START time: {} at the epoch {} ***********".format(start,epoch))
        ...
        print("********** (END - START) time: {} at the epoch {} ***********".format((end_time - start),epoch))
